                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <a href="{{ route('editor.news.create') }}" class="btn btn-sm bg-teal"><i
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-sm bg-blue"
                                                    href="{{ route('editor.news.edit', [$item->id]) }}"><span
                                                        class="fas fa-edit"></span></a>

                                                {{-- <form action="{{ route('editor.news.destroy', [$item->id]) }}" method="post"
