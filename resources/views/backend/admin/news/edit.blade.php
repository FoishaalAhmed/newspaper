        ...
        <div class="card card-default">
            <div class="card-header">
                ...
                <div class="card-tools">
					<a href="{{route('admin.news.index')}}" class="btn btn-sm bg-teal"><i class="fas fa-list-alt"></i> {{__('News')}}</a>
            ...
            <div class="card-body">
                ...
                <form action="{{route('admin.news.update', $news->id)}}" method="post" id="userForm" enctype="multipart/form-data">
					@csrf
					@method('PUT')
                    <div class="row">
						<div class="col-md-9">
